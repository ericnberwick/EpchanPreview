<template>
    <div class="bg-gray-800 h-full w-full border-t border-gray-600">
        <div class=" container mx-auto bg-gray-800 py-8">
                        ...
                        <div class="px-3 md:px-0 mr-4">
                            ...
                            <div class="w-full flex items-center py-4 mt-0">
                                ...
                                <!-- <a href="#" class="mx-2">
                                    ...
                                    <img class="w-7 h-7 fill-current" src="public/img/wiki.svg">
                            </a> -->
                                <!-- <a href="#" class="mx-2">
