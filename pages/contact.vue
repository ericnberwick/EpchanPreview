        ...
        <div class="px-8 py-24 bg-gray-800">
          <div class="container mx-auto text-center ">
            <h2
              ...
              Contact</h2>
            <p
              class="block antialiased font-sans text-base leading-relaxed text-inherit mb-4 font-normal !text-gray-500">
          ...
          <div class="space-x-2 max-w-md mx-auto my-auto mt-5 border border-border px-6 py-12  rounded-lg">
            ...
            <div class="mb-6">
              ...
              <textarea id="message" name="message" rows="4" placeholder="How can we help you?" v-model="message"
                required
