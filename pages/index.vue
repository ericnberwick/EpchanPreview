  ...
  <div class="bg-gray-800 text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <section class="bg-gray-800 py-8">
      <div class="container py-8 px-6 mx-auto">
        ...
        <p class="text-white">Ernest P. Chan, is an expert in machine learning and the application of quantitative
          models for asset
          ...
          that
          focuses
          on risk management and adaptive optimization using machine learning. Dr. Chan has built and traded numerous
          ...
          Netherlands, Peru, Singapore, South Africa, Sweden, the United Kingdom, and the United States since 2006.</p>
      </div>
    </section>
